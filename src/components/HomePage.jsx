...
function HomePage() {
  return (
    ...
    `}</style>
      <h2>Our mission:</h2>
      <p>We’d like to share our thoughts here about how and why we farm the way we do. If you eat our food, you have a hand in what we create. You support it and keep it going. These are some of our guiding thoughts that motivate the farm and farmers, and help create our food.</p><br/>

      <p>The mission of Red Fire Farm is to be a year-round local source for high quality food and ornamental crops grown at our farm using organic principles that result in safe food and a healthy environment.</p><br/><br/>
